          ...
          <div class="w-70 mr-5"> 
            <div class="bg-white border-2 border-blue rounded-xl mt-16">
                ...
                <form action="#" method="POST" class="space-y-6 px-4 py-6 ">
                    @csrf
                    <div>
                        <input type="text" class="w-full border-none text-sm py-2 px-4 rounded-xl placeholder-gray-900 bg-gray-100" placeholder="Your idea">
                    </div>
                    <div>
                        <select name="category_add" id="category_add " class="w-full rounded-xl border-none px-4 py-2 text-sm bg-gray-100">
                    ...
                    <div class="flex items-center justify-between space-x-3">
                        <button 
                        type="button" 
                        class="flex item-center justify-center w-1/2 h-11 text-sm bg-gray-100 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transtion duration-150 ease-in px-6 py-3">
              ...
              <nav class="flex items-center justify-between test-xs">
                  <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                      ...
                      <li><a href="" class="text-gray-400 transition duration-150 
                        ease-in border-b-4 pb-3 hover:border-blue">Considering (6)</a></li>
                      <li><a href="" class="text-gray-400 transition duration-150 
                        ease-in border-b-4 pb-3 hover:border-blue">In progress (1)</a></li>
                  </ul>

                  <ul class="flex uppercase font-semibold border-b-4 pb-3 space-x-10">
                      <li><a href="" class="text-gray-400 transition duration-150 
                        ease-in border-b-4 pb-3 hover:border-blue">Implemented (2)</a></li>
                      <li><a href="" class="text-gray-400 transition duration-150 
